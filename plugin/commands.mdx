...
5. Enabling platform tools
6. Adding MCP servers
7. Enabling connectors (Slack, Notion, GitHub)
8. Creating agents (multi-agent system)
9. Adding skills to agents
...
<Card title="MCP Tools" icon="wrench" href="/plugin/mcp-tools">
  See all 55+ MCP tools for programmatic access
</Card>
