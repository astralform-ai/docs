...
6. Enabling connectors (Slack, Notion, GitHub)
7. Creating agents (multi-agent system)
8. Adding skills to agents
9. Summary with next steps
...
5. Assigning skills, MCP servers, and platform tools
