...
The Astralform connector exposes 58 MCP tools that Claude can use to manage your Astralform projects. These are invoked automatically when you ask Claude to perform Astralform operations, on any surface where you've [added the connector](/plugin/connect).
