...
Each agent can have its own LLM provider and model. If a named agent has no LLM configured, it inherits from the Main Agent.

See [Agents](/dashboard/agents) for more on agent configuration.
