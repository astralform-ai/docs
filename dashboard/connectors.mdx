...
GitHub is different. There is **one** GitHub App — Astralform's — and you install it on your account or organisation. You create nothing and store nothing: no OAuth app, no client secret, no personal access token.
...
<Warning>
  Uninstalling the **GitHub** connector unbinds the agent from its GitHub account. It cannot uninstall the App from your account or organisation — that is yours to remove on GitHub, and the confirmation dialog links you there. If other agents in your workspace answer for the same account, the dialog says so, because removing the App on GitHub stops all of them.
</Warning>
