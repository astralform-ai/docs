...
```
AI: "I need to check the user's calendar"
    ↓
Backend sends tool_use event
    ↓
iOS SDK receives tool request
    ↓
Your app executes tool locally
    ↓
Result sent via POST /v1/tool-result
    ↓
AI continues with the data
```
